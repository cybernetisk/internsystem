...
class Kvittering(models.Model):
    ...
    zrapport = models.ForeignKey(
        Zrapport,
        related_name="kvitteringer",
        null=False,
        blank=False,
...
class Betalingstransaksjon(models.Model):
    betalingskonto = models.ForeignKey(
        Betalingskonto,
        related_name="transaksjoner",
        null=False,
        blank=False,
...
class KassenavnMapping(models.Model):
    ...
    salgsvare = models.ForeignKey(
        Salgsvare,
        related_name="kassenavn_mappinger",
        null=False,
        blank=False,
        on_delete=models.CASCADE,
    )
