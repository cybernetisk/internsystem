...
class FixturesTestCase(TestCase):
    ...
    def test_nfccard_fixtures(self):
        ...
        self.assertEqual(NfcCard.objects.count(), 1, "There are ony one NfcCard registered")

    def test_semester_fixtures(self):
        self.assertEqual(Semester.objects.count(), 6, "There are six semesters registererd")
